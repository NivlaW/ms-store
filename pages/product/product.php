...
<section class=" my-auto sm:p-5 antialiased">
    <div class="mx-auto max-w-screen-2xl h-screen px-4 lg:px-12">
        <div class="bg-white relative shadow-md sm:rounded-lg overflow-hidden">
            <form method="POST" action="?page=multi_delete1">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 ">
                        ...
                        <tbody>
                            ...
                            <tr class="border-b">
                                <td class="p-4 w-4">
                                    <div class="flex items-center">
                                        <input id="checkbox-table-search-1"<?php echo" name='id_produk[]' value=' {$x['id_produk']}' "?> type="checkbox" class="w-4 h-4 text-primary-600 bg-gray-100 rounded border-gray-300 focus:ring-primary-500 focus:ring-2">
