                        ...
                        <tr class="border-b">
                            ...
                            <td class="px-4 py-3 font-medium text-gray-900 truncate ">
                                <div class="flex items-center space-x-4">
                                    <a type="button" href="" class="py-2 px-3 flex items-center text-sm font-medium text-center text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:ring-4 focus:ring-gray-200 ">
                                    ...
                                    <a onclick="" href="" type="button" class="flex items-center text-red-700 hover:text-gray-100 hover border border-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-3 py-2 text-center ">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-2 -ml-0.5" viewbox="0 0 20 20" fill="currentColor" aria-hidden="true">
